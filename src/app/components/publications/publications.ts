import { Component, effect, ElementRef, inject, Input, model, signal, viewChild, ViewChild, viewChildren } from '@angular/core';
...
export class Publications {
  ...
  dragStart = signal<{
	...
	constructor() {
		toObservable(this.selectedCardId).pipe(skip(1)).subscribe((cardId) => {
